...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  # Incontáveis
  inflect.uncountable %w( tórax tênis ônibus lápis fênix rede_coletores_f8914 coletores_f8914 coletores_f8914_pinagem )

  inflect.irregular 'tipo_linha', 'tipos_linhas'
  inflect.irregular 'TipoLinha', 'TiposLinhas'
  inflect.irregular 'linha_ponto', 'linhas_pontos'
